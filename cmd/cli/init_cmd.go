...
After init, use 'gitbox account add' and 'gitbox source add' to configure
your accounts and repositories.`,
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		fmt.Println("     gitbox account add my-github \\")
		...
		fmt.Println("     gitbox source add my-github --account my-github")
		fmt.Println("")
		fmt.Println("  3. Add repos:")
		fmt.Println("     gitbox repo add my-github \"YourUser/repo-name\"")
		fmt.Println("")
		fmt.Println("  Or migrate from an existing git-config-repos.json:")
		fmt.Println("     gitbox migrate")
		fmt.Println("")
		fmt.Println("  For token (PAT) authentication:")
		fmt.Println("     gitbox account add my-gitea \\")
		...
		fmt.Println("     gitbox token store my-gitea")
