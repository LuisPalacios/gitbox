...
- **Workspaces de solo lectura** — gitbox descubre los archivos `.code-workspace` de VS Code existentes bajo las carpetas gestionadas, los lista en una pestaña Workspaces dedicada (GUI + TUI + CLI) y abre uno en mi editor. Nunca los crea ni los edita — los archivos son míos.
