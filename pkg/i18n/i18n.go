...
var catalogs = map[string]map[string]string{
	English: {
		...
		"cmd.workspace.short":          "List and open discovered VS Code workspaces",
		...
		"tui.settings.terminals":       "Terminal profiles…",
		"tui.settings.saved":           "Settings saved.",
		"tui.settings.error":           "Error: %s",
		"tui.terminals.title":          "Terminal profiles",
		"tui.terminals.detected_apps":  "Detected terminals",
		"tui.terminals.detected_shells": "Detected shells",
		"tui.terminals.profiles":       "Profiles",
		"tui.terminals.no_apps":        "No terminal apps detected. Launch the GUI once to populate this list.",
		"tui.terminals.no_shells":      "No shells detected.",
		"tui.terminals.no_profiles":    "No profiles yet. Press a to add one.",
		"tui.terminals.col_name":       "Name",
		"tui.terminals.col_command":    "Command",
		"tui.terminals.col_args":       "Args",
		"tui.terminals.col_terminal":   "Terminal",
		"tui.terminals.col_shell":      "Shell",
		"tui.terminals.col_default":    "●",
		"tui.terminals.col_preferred":  "★",
		"tui.terminals.col_hidden":     "👁",
		"tui.terminals.col_source":     "Source",
		"tui.terminals.add_title":      "Add profile",
		"tui.terminals.edit_title":     "Edit profile",
		"tui.terminals.field_name":     "Name",
		"tui.terminals.field_terminal": "Terminal",
		"tui.terminals.field_shell":    "Shell",
		"tui.terminals.saved":          "Saved.",
		"tui.terminals.deleted":        "Profile deleted.",
		"tui.terminals.cannot_delete":  "Only user-added profiles can be deleted; toggle Hidden instead.",
		"tui.terminals.no_apps_add":    "Add a terminal app via the GUI before creating profiles.",
		"tui.terminals.error":          "Error: %s",
		"tui.terminals.hint_actions":   "d default · p preferred · h hidden · e edit · a add · x delete",
	...
	Spanish: {
		...
		"cmd.workspace.short":          "Lista y abre workspaces de VS Code descubiertos",
		...
		"tui.settings.terminals":       "Perfiles de terminal…",
		"tui.settings.saved":           "Ajustes guardados.",
		"tui.settings.error":           "Error: %s",
		"tui.terminals.title":          "Perfiles de terminal",
		"tui.terminals.detected_apps":  "Terminales detectadas",
		"tui.terminals.detected_shells": "Shells detectadas",
		"tui.terminals.profiles":       "Perfiles",
		"tui.terminals.no_apps":        "No se detectaron terminales. Abre la GUI una vez para rellenar la lista.",
		"tui.terminals.no_shells":      "No se detectaron shells.",
		"tui.terminals.no_profiles":    "Aún no hay perfiles. Pulsa a para añadir uno.",
		"tui.terminals.col_name":       "Nombre",
		"tui.terminals.col_command":    "Comando",
		"tui.terminals.col_args":       "Args",
		"tui.terminals.col_terminal":   "Terminal",
		"tui.terminals.col_shell":      "Shell",
		"tui.terminals.col_default":    "●",
		"tui.terminals.col_preferred":  "★",
		"tui.terminals.col_hidden":     "👁",
		"tui.terminals.col_source":     "Origen",
		"tui.terminals.add_title":      "Añadir perfil",
		"tui.terminals.edit_title":     "Editar perfil",
		"tui.terminals.field_name":     "Nombre",
		"tui.terminals.field_terminal": "Terminal",
		"tui.terminals.field_shell":    "Shell",
		"tui.terminals.saved":          "Guardado.",
		"tui.terminals.deleted":        "Perfil eliminado.",
		"tui.terminals.cannot_delete":  "Solo se pueden eliminar perfiles creados por el usuario; usa Oculto en su lugar.",
		"tui.terminals.no_apps_add":    "Añade una terminal desde la GUI antes de crear perfiles.",
		"tui.terminals.error":          "Error: %s",
		"tui.terminals.hint_actions":   "d por defecto · p preferido · h oculto · e editar · a añadir · x borrar",
