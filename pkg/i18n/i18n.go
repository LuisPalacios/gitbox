...
var catalogs = map[string]map[string]string{
	...
	Spanish: {
		...
		"tui.dashboard.attention":      "requieren atencion",
		...
		"tui.dashboard.create_ws_hint": "Pulsa n para crear uno. Selecciona clones en la pestana Cuentas (espacio / A) y pulsa w para crear un workspace con ellos.",
		"tui.dashboard.not_generated":  "(sin generar todavia)",
		"tui.dashboard.delete_ws":      "Eliminar %q? (y/n)  El archivo generado se conserva en disco.",
		"tui.dashboard.keyboard":       "Atajos de teclado",
		"tui.dashboard.status_symbols": "Simbolos de estado",
